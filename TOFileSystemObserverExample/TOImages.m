...
+ (UIImage *)documentPickerDefaultFolderForStyle:(BOOL)darkMode
{
    ...
    return [TOImages documentPickerFolderIconWithSize:kTODocumentPickerDefaultFolderIconSize
                                                     ...
                                                     style:(BOOL)darkMode
{
    ...
    return [TOImages documentPickerIconWithSize:kTODocumentPickerDefaultFileIconSize
